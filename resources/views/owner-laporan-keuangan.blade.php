          ...
          <div class="header-box bg-white border border-gray-300 rounded-lg shadow-lg flex justify-between items-center py-4 px-6 lg:px-12">
            ...
            <div class="hidden lg:flex items-center w-full justify-between">
              ...
              <div class="flex space-x-6">
                <a href="{{url('/owner/beranda')}}" class="nav-link hover:bg-[#2B7A78] hover:text-[#DEF2F1] text-gray-600 rounded-md px-4 py-2 font-semibold" onclick="setActiveLink(event)">Beranda</a>
                ...
                <a href="{{url('/owner/laporan-keuangan')}}"class="nav-link text-white bg-[#2B7A78] rounded-md px-4 py-2 font-semibold" onclick="setActiveLink(event)">Laporan Keuangan</a>
              </div>
        ...
        <div class="flex-1 bg-[#D1DDD5] overflow-hidden">
          <div class="flex justify-between items-center mt-12 px-8">
           <!-- button trigger modal -->
            <button onclick="openModal()" class="bg-[#2B7A78] text-white font-semibold py-2 px-4 rounded-lg hover:bg-[#205C5D]">
              + Tambah hutang
            </button>
          </div>
