                    ...
                    <form method="GET" action="{{ url()->current() }}" class="p-6">
                        <div class="flex flex-col sm:flex-row items-end gap-4">
                            ...
                            <div class="w-full sm:w-auto flex gap-2">
                                <button type="submit" class="px-6 py-2 bg-[#468585] hover:bg-[#234343] text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                        Filter
                                </button>
                                @if(request('tanggal_awal') || request('tanggal_akhir'))
                                    <a href="{{ url()->current() }}" class="inline-flex justify-center items-center px-6 py-2 bg-red-500 hover:bg-red-700 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
                                        Reset
                                    </a>
                                @endif
                            </div>
