                    ...
                    <form method="GET" action="" class="p-6">
                        <div class="flex flex-col sm:flex-row items-end gap-4">
                            <div class="w-full sm:w-auto flex-grow">
                                <label for="tanggal_awal" class="block text-sm font-medium text-gray-700 mb-1">Mulai
                                    Tanggal</label>
                                <div class="relative">
                            ...
                            <div class="w-full sm:w-auto flex-grow">
                                <label for="tanggal_akhir" class="block text-sm font-medium text-gray-700 mb-1">Sampai
                                    Tanggal</label>
                                <div class="relative">
