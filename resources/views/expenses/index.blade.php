            ...
            <div class="flex items-center space-x-4">
              ...
              <form action="{{ route('expenses.search') }}" method="GET" class="flex items-center max-w-md">
                  <div class="relative w-full">
                      <label for="search" class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Cari pengeluaran</label>
     ...
     <!-- sidebar content -->
      <div class="drawer-side">
        ...
        <ul class="menu text-black min-h-full w-80 p-4 bg-white">
          ...
          <li>
            <a href="{{ url('/keuangan/menu') }}" class="menu-link text-black hover:bg-[#2B7A78] hover:text-[#DEF2F1] mb-4 block w-full px-4 py-2 flex items-center gap-2">
