@section('title', 'Kategori | Sumber keluar')
<x-app-layout>
    ...
    <div class="drawer lg:drawer-open">
                  ...
                  <table class="table w-full table-auto">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <a href="{{ route('sumber-keluar.edit', $bill->id) }}" class="btn btn-sm btn-primary bg-[#2B7A78] hover:bg-[#205C5D]">Edit</a>
      ...
      <div class="drawer-side">
        ...
        <ul class="menu text-black min-h-full w-80 p-4 bg-white">
          ...
          <li class="relative">
            <!-- Dropdown Kategori -->
              <button id="dropdownKategoriButton" onclick="dropdownKategori()" class="bg-[#2B7A78] text-white hover:bg-[#2B7A78] hover:text-[#DEF2F1] mt-2 mb-2 block w-full px-4 py-2 text-left flex items-center gap-2">
