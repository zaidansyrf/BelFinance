      ...
      <div class="drawer-content flex flex-col h-screen">
        ...
        <div class="flex-1 bg-[#D1DDD5] overflow-auto">
          <div class="sticky justify-between items-center mt-12 px-8">
            ...
            <form action="{{ route('uang-masuk.search') }}" method="GET" class="flex items-center max-w-md">
                            ...
                            @foreach ($income->sortByDesc('date')->values() as $i)
                                <tr class="hover:bg-gray-100/50">
                                    ...
                                    <td class="text-black px-4 py-2">
                                        <a href="{{ url('keuangan/uang-masuk/' . $i->id) }}" class="text-white btn btn-sm bg-[#2B7A78] hover:bg-[#205C5D]">Detail</a>
                                    </td>
     ...
     <!-- sidebar content -->
      <div class="drawer-side">
        ...
        <ul class="menu text-black min-h-full w-80 p-4 bg-white">
          ...
          <li class="relative">
            <button id="dropdownPemasukkanButton" onclick="dropdownPemasukkan()" class="bg-[#116A71] text-white hover:bg-[#2B7A78] hover:text-[#DEF2F1] mt-2 mb-2 block w-full px-4 py-2 text-left flex items-center gap-2 transition-colors duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 96.2" class="w-4 h-4 fill-current text-white group-hover:text-[#DEF2F1] transition-colors duration-200">
