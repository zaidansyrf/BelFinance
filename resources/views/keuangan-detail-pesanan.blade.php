    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col h-screen">
        ...
        <div class="flex-1 bg-[#D1DDD5] overflow-auto">
          ...
          <button type="button" class="bg-[#2B7A78] text-white font-semibold py-2 px-6 rounded-lg hover:bg-[#205C5D]" onclick="window.location.href='{{url('/keuangan/dashboard')}}'">
                &larr; Kembali
              </button>
              ...
              <div class="card text-primary-content bg-white mt-4 w-full">
                <div class="card-body">
                    ...
                    <table>
                      <thead>
                          <tr>
                              <th class="py-2 px-4 border-b text-left text-gray-800">Nama Sumber</th>
                              ...
                              <th class="py-2 px-4 border-b text-left text-gray-800">Total Harga</th>
                          </tr>
                      </thead>
                      <tbody>
                          @foreach ($details as $detail)
                          <tr>
                              <td class="text-black px-4 py-2">{{ $detail->income->source->name }}</td>
                              <td class="text-black px-4 py-2">{{ $detail->item->name }}</td>
                              <td class="text-black px-4 py-2">{{ $detail->quantity }}</td>
                              <td class="text-black px-4 py-2">Rp {{ number_format($detail->subtotal, 0, ',', '.') }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                  </table>
     ...
     <!-- sidebar content -->
      <div class="drawer-side">
        ...
        <ul class="menu text-black min-h-full w-80 p-4 bg-white">
          ...
          <!-- Sidebar Menu Links -->
          <li>
            <a href="{{ url('/keuangan/dashboard') }}" class="bg-[#116A71] text-white  hover:bg-[#2B7A78] hover:text-[#DEF2F1] mb-2 block w-full px-4 py-2">
            Dashboard
            </a>
          </li>
          <li class="relative">
          ...
          <li>
            <a href="{{ url('/keuangan/menu') }}" class="menu-link text-black hover:bg-[#2B7A78] hover:text-[#DEF2F1] mb-4 block w-full px-4 py-2 flex items-center gap-2 group">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 90.02" fill="currentColor" class="w-5 h-5 icon group-hover:text-white">
