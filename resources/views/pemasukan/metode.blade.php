<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Data Pemasukan dengan Metode ' . ucfirst($metode)) }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4">Data Pemasukan dengan Metode {{ ucfirst($metode) }}</h3>

                    <a href="{{ route('pemasukan.create') }}" class="bg-green-500 text-white px-4 py-2 rounded">Tambah Pemasukan</a>
                    <a href="{{ route('pemasukan.index') }}" class="bg-red-500 text-white px-4 py-2 rounded">Kembali</a>
